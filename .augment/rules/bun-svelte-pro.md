...
_Source: @tsconfig/svelte npm package (2024-12); svelte.dev/docs/svelte/typescript_
...
_Source: svelte.dev/docs/svelte/$state (2024-12)_
...
_Source: svelte.dev/docs/svelte/$derived (2024-12)_
...
_Source: joyofcode.xyz/learn-svelte (2024)_
...
_Source: svelte.dev/docs/svelte/$effect "When not to use $effect" section (2024-12)_
...
_Source: svelte.dev/docs/svelte/v5-migration-guide (2024-12)_
...
_Source: svelte.dev/docs/svelte/snippet; frontendmasters.com/blog/snippets-in-svelte-5 (2024)_
...
_Source: svelte.dev/docs/svelte/snippet (2024-12)_
...
_Source: svelte.dev/docs/kit/form-actions (2024-12)_
...
_Source: svelte.dev/docs/kit/routing (2024-12)_
...
_Source: bun.sh/docs/runtime/sqlite (2024)_
...
_Source: SQLite documentation; bun.sh/docs/runtime/sqlite_
...
_Source: svelte.dev/docs/kit/load#Errors (2024-12)_
...
_Source: svelte.dev/tutorial/kit/handleerror (2024-12)_
...
_Source: frontendmasters.com/blog/fine-grained-reactivity-in-svelte-5 (2024)_
...
_Source: svelte.dev/docs/svelte/svelte-reactivity (2024-12)_
...
_When to use:_ Large arrays from APIs, performance-critical scenarios, data you won't mutate in place.

_Source: svelte.dev/docs/svelte/$state#$state.raw (2024-12)_
...
_Source: svelte.dev/docs/svelte/context (2024-12)_
...
_Source: mainmatter.com/blog/2025/03/11/global-state-in-svelte-5 (2025-03)_
...
_Source: jamesy.dev/blog/svelte-5-states-avoiding-common-reactivity-traps (2024)_
...
_Source: github.com/sveltejs/svelte/issues/11806 (2024)_
...
_Source: svelte.dev/docs/svelte (2024-12)_
...
_Source: svelte.dev/docs/kit/load (2024-12)_
...
_Source: svelte.dev/tutorial/kit/universal-load-functions (2024-12)_
...
_Caveat:_ Streaming requires JavaScript—only stream non-essential data.

_Source: svelte.dev/blog/streaming-snapshots-sveltekit (2023)_
...
_Source: svelte.dev/docs/kit/$app-navigation (2024-12)_
...
_Source: svelte.dev/tutorial/kit/customizing-use-enhance (2024-12)_
...
<script>
	...
	$effect(() => {
		if (!element) return;
		const animation = animate(element, { opacity: [0, 1], x: [-100, 0] }, { duration: 0.5 });
...
_Source: motion.dev Quick Start (2024-12); github.com/motiondivision/motion_
...
_Source: github.com/epavanello/motion-svelte (2024-11)_
...
_Source: GSAP Forum "SvelteKit 2 + GSAP - ScrollTrigger" (2024-06)_
...
_Source: gsap.com/docs/v3/GSAP/Timeline (2024)_
...
_Source: motion.dev/docs/stagger (2024-12)_
...
_Source: gsap.com/docs/v3/GSAP/gsap.context() (2024)_
...
_Source: motion.dev/docs/performance (2024-12)_
...
_Source: svelte.dev/docs/svelte/svelte-motion (2024-12)_
...
_Source: gsap.com/docs/v3/GSAP/gsap.matchMedia() (2024)_
...
_Recommendation:_ Use Motion for entry/exit animations and simple interactions; use GSAP for complex scroll-linked animations and precise timeline control.

_Source: motion.dev "GSAP vs Motion: A detailed comparison" (2024)_
...
_Source: Svelte 5 documentation (2024-12)_
...
_Source: vercel.com/blog/bun-runtime-on-vercel-functions (2024-12)_
...
_Source: vercel.com/blog/whats-new-in-svelte-5 (2024)_
...
_Source: unocss.dev/integrations/svelte-scoped (2024)_

- **Enable attributify mode for cleaner markup.**

```svelte
<button bg="blue-400 hover:blue-500" text="sm white" p="y-2 x-4"> Button </button>
```

_Source: unocss.dev/presets/attributify (2024)_
...
_Source: svelte.dev/docs/kit/page-options (2024-12)_
...
_Source: lucide.dev/guide/packages/lucide-svelte (2024)_
...
_Source: bun.sh/docs/cli/test (2024)_
...
_Source: scottspence.com "Testing Svelte with Vitest Browser Mode" (2025)_
...
_Source: playwright.dev; svelte.dev/docs/svelte/testing (2024-12)_
...
_Source: svelte.dev/docs/svelte/testing (2024-12)_
...
_Source: biomejs.dev/blog/biome-v2-3 (2025)_
...
_Source: svelte.dev/docs/svelte/typescript (2024-12)_
...
_Source: bun.sh/docs/runtime/bunfig (2024)_
...
_Source: orm.drizzle.team (2024-2025)_
...
_Source: svelte.dev/docs/kit/types (2024-12)_
...
_Source: valibot.dev/guides/comparison (2024); builder.io/blog/introducing-valibot (2024)_
...
_Source: typescriptlang.org/docs/handbook/release-notes/typescript-4-9 (2022)_
...
_Source: svelte.dev/docs/svelte/typescript#Generic-$props (2024-12)_
...
_Source: bun.sh/docs/runtime/sqlite (2024); OWASP SQL Injection Prevention_
...
_Source: svelte.dev/docs/kit/configuration#csrf (2024-12)_
...
_Source: superforms.rocks (2024)_
...
_Source: svelte.dev/docs/kit/hooks (2024-12)_
...
_Source: svelte.dev/docs/kit/configuration#csp (2024-12)_
...
_Source: svelte.dev/tutorial/kit/env-static-private (2024-12)_
...
_Source: support.plex.tv "Finding an authentication token" (2024)_
...
_Source: shadcn-svelte.com/docs/installation/sveltekit (2024)_
...
_Source: shadcn-svelte.com/docs/installation/manual (2024)_
...
_Source: tweakcn.com (2024-2025)_
...
_Source: github.com/unocss-community/unocss-preset-shadcn (2024)_
...
_Source: shadcn-svelte.com/docs/components/form (2024); superforms.rocks (2024)_
...
_Source: shadcn-svelte.com/docs/components/form (2024)_
...
_Source: github.com/Hexagon/croner (2024); croner.56k.guru (2024)_
...
_Source: dev.to/ranjanpurbey/background-jobs-in-sveltekit-with-bullmq (2025-01)_
...
_Source: plexapi.dev/SDKs (2024); npm @lukehagar/plexjs_
...
_Source: plexapi.dev/api-reference (2024)_
...
_Source: support.plex.tv/articles/115002267687-webhooks (2024)_
...
_Source: github.com/Hexagon/croner (2024)_
